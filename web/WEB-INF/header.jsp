            ...
            <!-- ul class="dropdown-menu">
              <li>
                <div class="cart-item product-summary">
                  <div class="row">
                    <div class="col-xs-4">
                      <div class="image"> <a href="detail.html"><img src="${pageContext.request.contextPath}/assets/images/products/p4.jpg" alt=""></a> </div>
                    </div>
                    <div class="col-xs-7">
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown"> <a href="/ColobaneOnline/categories">Cat�gories</a></li>
                <li class="dropdown hidden-sm">
                  <a href="/ColobaneOnline/bestSells">Meilleures Ventes<span class="menu-label hot-menu hidden-xs">hot</span></a>
                </li>
                <li class="dropdown hidden-sm">
                  <a href="/ColobaneOnline/newItems">Derni�res Nouveaut�s<span class="menu-label new-menu hidden-xs">new</span> </a>
                </li>
                ...
                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">� Propos</a>
                  <ul class="dropdown-menu pages">
                    <li>
                      <div class="yamm-content">
                        <div class="row">
