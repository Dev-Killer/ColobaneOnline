                      ...
                      <div class="fld inline">
                        <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                          ...
                          <ul role="menu" class="dropdown-menu">
                            <li role="presentation"><a href="/ColobaneOnline/newItems">Par Défaut</a></li>
                            <li role="presentation"><a href="/ColobaneOnline/newItems?action=lower">Prix Croissant</a></li>
                            <li role="presentation"><a href="/ColobaneOnline/newItems?action=upper">Prix Décroissant</a></li>
                            <li role="presentation"><a href="/ColobaneOnline/newItems?action=atoz">Nom A à Z</a></li>
                            <li role="presentation"><a href="/ColobaneOnline/newItems?action=ztoa">Nom Z à A</a></li>
                          </ul>
                        </div>
                      </div>
                      <!-- /.fld -->
